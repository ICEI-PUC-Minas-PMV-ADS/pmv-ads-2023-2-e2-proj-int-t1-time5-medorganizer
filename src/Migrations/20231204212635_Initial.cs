        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultas_Clinica_ClinicaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exames_Clinica_ClinicaId",
                        column: x => x.ClinicaId,
                        principalTable: "Clinica",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exames_Consultas_ConsultaMedicaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstrucoesAdicionais = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prescricao", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Prescricao_Consultas_ConsultaMedicaId",
                        column: x => x.ConsultaMedicaId,
                        principalTable: "Consultas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Prescricao_Medicamentos_MedicamentoId",
                        column: x => x.MedicamentoId,
                        principalTable: "Medicamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescricao_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicacoes_Clinica_ClinicaId",
                        column: x => x.ClinicaId,
                        principalTable: "Clinica",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Medicacoes_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Medicacoes_Prescricao_PrescricaoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exames_ConsultaMedicaId",
                table: "Exames",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicacoes_ClinicaId",
                table: "Medicacoes",
                column: "ClinicaId");

            migrationBuilder.CreateIndex(
                name: "IX_Medicacoes_MedicoId",
                table: "Medicacoes",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_Medicacoes_PrescricaoId",
                table: "Medicacoes",
                column: "PrescricaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Prescricao_ConsultaMedicaId",
                table: "Prescricao",
                column: "ConsultaMedicaId");
